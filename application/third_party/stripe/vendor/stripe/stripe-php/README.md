...
A simple example of charging a customer $10:
...
Or, when using with a [Stripe Connect](https://stripe.com/connect) platform, you can specify the connected account's ID:
